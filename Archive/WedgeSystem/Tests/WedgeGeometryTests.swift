...
final class WedgeGeometryTests: XCTestCase {
    ...
    func testLODLevelsGenerateCorrectly() {
        ...
        // LOD2 (low): v4 tent shape — 3 base + 1 peak = 4 vertices, 3 tent faces
        ...
        XCTAssertGreaterThanOrEqual(result2.vertices.count, 4, "LOD2 should have at least 4 vertices (3 base + peak)")
