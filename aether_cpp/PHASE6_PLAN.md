...
| Step 4 ✅ | 🆕 splat_render.wgsl + harness vert+frag extension | done | 4 splats render to 256×256 RGBA8 PASS — center=(162,162,162,254), corner=(0,0,0,0), Gaussian falloff confirmed (mid α=11 < center α=254), no NaN |
