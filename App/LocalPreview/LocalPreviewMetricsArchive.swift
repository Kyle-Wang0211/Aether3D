...
enum LocalPreviewMetricsArchive {
    static func runtimeMetrics(
        ...
        metrics["native_current_retained_export_gaussians"] = String(snapshot.retained_export_gaussians)
        metrics["native_peak_gaussians"] = String(snapshot.peak_training_gaussians)
        metrics["native_peak_working_set"] = String(snapshot.peak_working_set_gaussians)
        metrics["native_peak_retained_export_gaussians"] = String(snapshot.peak_retained_export_gaussians)
